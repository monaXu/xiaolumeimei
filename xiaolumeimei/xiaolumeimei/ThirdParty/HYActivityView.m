...
- (void)setup
{
    ...
    self.bgColor = [UIColor colorWithRed:227.0/255.0 green:227.0/255.0 blue:227.0/255.0 alpha:1.0f];
    ...
    [self.cancelButton setTitleColor:[UIColor colorWithRed:77.0/255.0 green:135.0/255.0 blue:196.0/255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(20, -self.frame.size.height+210, 280, 1)];
    lineView.backgroundColor = [UIColor colorWithRed:77.0/255.0 green:135.0/255.0 blue:196.0/255.0 alpha:1.0];
...
#warning 改约束
    ...
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-20-[cancelButton]-20-|" options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
